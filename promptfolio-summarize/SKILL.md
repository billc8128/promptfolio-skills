...
2. **Instances** — highlight 2-3 of the most interesting instances from Phase 1 (user-AI collaboration stories)
3. **Framework Sentences** — the curated quotes from Phase 2 with their interpretations
4. **Portrait** — the summary and dimensional analysis
